...
class PosDetailsInclusive(models.TransientModel):
    _name = 'pos.details.inclusive.wizard'
    _description = 'Point of Sale Details Report (Inclusive)'
    ...
    show_reservations = fields.Boolean(default=True)
    pos_config_ids = fields.Many2many('pos.config', 'pos_detail_inclusive_configs',
    ...
    def generate_report(self):
        ...
        return self.env.ref('sale_report_inclusive.sale_details_inclusive_report').report_action([], data=data)
