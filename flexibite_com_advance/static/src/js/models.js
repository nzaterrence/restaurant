odoo.define('flexibite_com_advance.models', function (require) {
	...
	models.PosModel.prototype.models.push({
        ...
        loaded: function(self, pos_promotions){
            console.log('load promotions model', pos_promotions);
...
//        },
	    ...
	    load_server_data: function () {
	        ...
	        return posmodel_super.load_server_data.apply(this, arguments).then(function () {
            	...
            	if(self.config.multi_shop_id && self.config.multi_shop_id.length > 0){
												...
												if(line.product.pos_categ_id){
													...
													if(product_category){
														if($.inArray(product_category.id, line_record.product_categ_ids) != -1){
														    if(line_record.discount_type != 'percentage'){
...
//                                        order.set_discount_history(true);
     ...
     //Rounding
        ...
        set_pay_ref: function(pay_ref){
        	this.pay_ref = pay_ref;
        },
        get_pay_ref: function(){
        	return this.pay_ref;
        },
        ...
        export_for_printing: function(){
            ...
            var new_val = {
            	...
            	pay_ref: this.get_pay_ref() || false,
    ...
    models.Orderline = models.Orderline.extend({
        initialize: function(attr,options){
            ...
            this.line_note = '';
            this.state = 'waiting';
            this.state_label = {'waiting': '等待', 'done': '完成', 'preparing': '准备', 'delivering': '发货中', 'cancel': '取消'};
            this.oid = null;
            this.backorder = null;
        ...
        get_state: function(){
            return this.state_label[this.state];
        },
