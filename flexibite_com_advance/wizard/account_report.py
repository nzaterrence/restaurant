...
class AccountingReport(models.TransientModel):
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('flexibite_com_advance.action_report_financial').report_action(self, data=data, config=False)

    def print_xls(self):
        report_obj = self.env['report.flexibite_com_advance.report_financial']
        data = {}
        data['form'] = \
