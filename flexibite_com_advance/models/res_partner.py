...
class partner_payment_transaction(models.TransientModel):
    ...
    paid_pos_order__paid_ids = fields.One2many('pos.order.details', 'partner_payment_id', string='Pos Order')
    paid_pos_order_open_ids = fields.One2many('pos.order.details', 'partner_payment_id_open', string='Pos Order',)
...
class pos_order_details(models.TransientModel):
    ...
    partner_payment_id_open = fields.Many2one('partner.payment.transaction', string='Payment')
