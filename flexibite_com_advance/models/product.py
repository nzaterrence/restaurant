    ...
    def write(self, vals):
        ...
        for product in self:
            ...
            if product_ids:
                ...
                """%(self.write_date, ','.join(map(str, product_ids._ids))))
        return res
...
class ProductProduct(models.Model):
    ...
    def load_latest_product(self,write_date,fields,context):
        ...
        variant_ids = self.with_context(context).search([("sale_ok", "=", True),("available_in_pos", "=", True)])
    ...
    @api.model
    def calculate_product(self, config_id, product_fields):
        ...
        if pos_session and config.multi_shop_id and pos_session.shop_id:
            product_ids = pos_session.get_products_category_data(product_fields, True)
